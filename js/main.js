...
/* ---------- BRAND CONFIG (edit these to customize) ---------- */
const BRAND = {
  name: "ShopEase",
  whatsappNumber: "919999999999", // replace with your WhatsApp number (country code + number, no + or spaces)
  email: "support@shopease.example.com",
  phone: "+91 99999 99999",
  address: "123, MG Road, Bengaluru, Karnataka, India - 560001",
  upiId: "shopease@upi", // replace with your real UPI ID
  ...
  footer.innerHTML = `
    <div class="container footer-inner">
      <div class="footer-col">
        <img src="assets/images/logo.svg" alt="${BRAND.name}" width="140" style="margin-bottom:12px; filter:brightness(0) invert(1);">
        <p>Your trusted online store for quality products at honest prices. Shop with confidence.</p>
        <div class="social-icons">
          <a href="${BRAND.facebook}" target="_blank" rel="noopener" aria-label="Facebook">
            <svg viewBox="0 0 24 24"><path d="M22 12a10 10 0 1 0-11.5 9.9v-7H7.9V12h2.6V9.8c0-2.6 1.5-4 3.9-4 1.1 0 2.3.2 2.3.2v2.5h-1.3c-1.3 0-1.7.8-1.7 1.6V12h2.9l-.5 2.9h-2.4v7A10 10 0 0 0 22 12"/></svg>
          </a>
          <a href="${BRAND.instagram}" target="_blank" rel="noopener" aria-label="Instagram">
            <svg viewBox="0 0 24 24"><path d="M12 2c2.7 0 3.1 0 4.1.06 1.1.05 1.8.2 2.4.45.7.27 1.2.6 1.7 1.1.5.5.87 1 1.1 1.7.25.6.4 1.3.45 2.4.06 1 .06 1.4.06 4.1s0 3.1-.06 4.1c-.05 1.1-.2 1.8-.45 2.4a4.6 4.6 0 0 1-1.1 1.7c-.5.5-1 .87-1.7 1.1-.6.25-1.3.4-2.4.45-1 .06-1.4.06-4.1.06s-3.1 0-4.1-.06c-1.1-.05-1.8-.2-2.4-.45a4.6 4.6 0 0 1-1.7-1.1 4.6 4.6 0 0 1-1.1-1.7c-.25-.6-.4-1.3-.45-2.4C2 15.1 2 14.7 2 12s0-3.1.06-4.1c.05-1.1.2-1.8.45-2.4.24-.7.6-1.2 1.1-1.7.5-.5 1-.87 1.7-1.1.6-.25 1.3-.4 2.4-.45C8.9 2 9.3 2 12 2zm0 1.8c-2.66 0-2.98 0-4.04.06-.9.04-1.4.19-1.7.31-.44.17-.75.37-1.08.7-.33.33-.53.64-.7 1.08-.12.32-.27.8-.31 1.7C4.1 9 4.1 9.3 4.1 12s0 2.98.06 4.04c.04.9.19 1.4.31 1.7.17.44.37.75.7 1.08.33.33.64.53 1.08.7.32.12.8.27 1.7.31 1.06.06 1.38.06 4.04.06s2.98 0 4.04-.06c.9-.04 1.4-.19 1.7-.31.44-.17.75-.37 1.08-.7.33-.33.53-.64.7-1.08.12-.32.27-.8.31-1.7.06-1.06.06-1.38.06-4.04s0-2.98-.06-4.04c-.04-.9-.19-1.4-.31-1.7a2.9 2.9 0 0 0-.7-1.08 2.9 2.9 0 0 0-1.08-.7c-.32-.12-.8-.27-1.7-.31C14.98 3.8 14.66 3.8 12 3.8zm0 3.05a5.15 5.15 0 1 1 0 10.3 5.15 5.15 0 0 1 0-10.3zm0 8.5a3.35 3.35 0 1 0 0-6.7 3.35 3.35 0 0 0 0 6.7zm5.35-8.7a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0z"/></svg>
          </a>
          <a href="${BRAND.twitter}" target="_blank" rel="noopener" aria-label="Twitter">
            <svg viewBox="0 0 24 24"><path d="M22 5.9c-.7.3-1.5.5-2.3.6.8-.5 1.4-1.3 1.7-2.3-.8.5-1.7.8-2.6 1a4.1 4.1 0 0 0-7 3.7A11.6 11.6 0 0 1 3.4 4.6a4.1 4.1 0 0 0 1.3 5.5c-.7 0-1.3-.2-1.9-.5v.05a4.1 4.1 0 0 0 3.3 4 4.2 4.2 0 0 1-1.9.07 4.1 4.1 0 0 0 3.8 2.9A8.3 8.3 0 0 1 2 18.4a11.6 11.6 0 0 0 6.3 1.9c7.5 0 11.7-6.3 11.7-11.7v-.5c.8-.6 1.5-1.3 2-2.2z"/></svg>
          </a>
          <a href="${BRAND.youtube}" target="_blank" rel="noopener" aria-label="YouTube">
            <svg viewBox="0 0 24 24"><path d="M23 12s0-3.6-.46-5.3a2.9 2.9 0 0 0-2-2C18.9 4.2 12 4.2 12 4.2s-6.9 0-8.54.5a2.9 2.9 0 0 0-2 2C1 8.4 1 12 1 12s0 3.6.46 5.3a2.9 2.9 0 0 0 2 2c1.64.5 8.54.5 8.54.5s6.9 0 8.54-.5a2.9 2.9 0 0 0 2-2C23 15.6 23 12 23 12zM9.8 15.5v-7l6.2 3.5-6.2 3.5z"/></svg>
          </a>
        </div>
      </div>
      <div class="footer-col">
      ...
      <div class="footer-col">
        ...
        <ul>
          ...
          <li><a href="mailto:${BRAND.email}">✉️ ${BRAND.email}</a></li>
          <li>📍 ${BRAND.address}</li>
        </ul>
    ...
    <div class="footer-bottom container">
      ...
      Built for demo purposes — replace with your own store details.
    </div>
  `;
...
/* ---------- SEND SCREENSHOT MESSAGE HELPER (used on payment.html) ---------- */
function buildWhatsappOrderLink(productName, amount) {
  const message = `Hi ${BRAND.name}! I have completed the UPI payment of ₹${amount} for "${productName}". Sending my payment screenshot here for confirmation. 🧾`;
